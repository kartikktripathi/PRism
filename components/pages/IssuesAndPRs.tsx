...
export default function IssuesAndPRs({ session, username }: IssuesAndPRsProps) {
  ...
  // Grayscale color palette generator for labels (no hue, shades of gray)
              ...
              return (
                <button
                  ...
                  className={`px-3 py-2 text-xs rounded-t font-mono transition-all border-b-2 cursor-pointer capitalize ${
                    isActive
                      ? "border-white text-white font-medium bg-zinc-900/30"
            ...
            <div className="rounded-lg border border-zinc-850 border-dashed bg-zinc-950/10 py-12 text-center font-mono">
              ...
              {(searchQuery ||
                ...
                <button
                  ...
                  className="mt-3.5 text-[10px] text-zinc-400 hover:text-white hover:underline cursor-pointer transition-colors"
                >
                      ...
                      <div className="space-y-1.5 min-w-0">
                        <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
                          ...
                          {item.isReviewRequested && (
                            <span className="text-[9px] bg-zinc-900 border border-zinc-800 text-zinc-300 font-mono px-1.5 py-0.5 rounded-full">
                              Review Requested
                            </span>
                          )}
                          {item.isAssigned && (
                            <span className="text-[9px] bg-zinc-900 border border-zinc-800 text-zinc-400 font-mono px-1.5 py-0.5 rounded-full">
                              Assigned
                            </span>
                          )}
                        </div>
